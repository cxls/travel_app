 ...
 * @date 2024/5/25
 */
public class RecyclerViewAdapter extends AppAdapter<TravelGuideListApi.Bean> {
    ...
    private final class ViewHolder extends AppAdapter<?>.ViewHolder {
        ...
        public void onBindView(int position) {
            ...
            TravelGuideListApi.Bean item = getItem(position);
            if (item == null){
                return;
            }
...
//            publisherView.setText(item.get());
